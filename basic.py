...
def calculate_savings(employee_gross_pay, employee_tax_rate, employee_expenses):
...
def compute_material_waste(available_material, material_unit, jobs_count, consumption_per_job):
    total_waste = available_material - (jobs_count * consumption_per_job)
    return str(total_waste) + material_unit

def calculate_interest(starting_principal, interest_rate, investment_periods):
